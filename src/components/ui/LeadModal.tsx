                            ...
                            <div style={{ padding: 'var(--spacing-6)', overflowY: 'auto', WebkitOverflowScrolling: 'touch', flex: 1, minHeight: 0 }}>
                                {isSubmitted ? (
                                    <div className="flex-col items-center justify-center text-center" style={{ padding: 'var(--spacing-8) 0' }}>
                                        ...
                                        <h3 style={{ fontSize: '1.5rem', marginBottom: 'var(--spacing-2)', color: 'var(--color-primary)', fontWeight: 600 }}>Request Received</h3>
                                    ...
                                    <>
                                        <h2 style={{ fontSize: '1.5rem', fontWeight: 600, color: 'var(--color-primary)', marginBottom: 'var(--spacing-2)' }}>
                                            {selectedDoc ? `Download ${selectedDoc}` : type ? titles[type] : 'Get Started'}
                                        </h2>
                                        <p style={{ color: 'var(--color-on-surface-variant)', fontSize: '0.85rem', marginBottom: 'var(--spacing-4)', lineHeight: 1.4 }}>
                                        ...
                                        {type === 'download' && !selectedDoc ? (
                                                ...
                                                {[
                                                    ...
                                                    { title: 'Agent Deployment Strategy', type: 'Playbook • 3.5 MB' }
                                                        ...
                                                        <div key={idx} style={{ 
                                                            ...
                                                            background: 'var(--color-surface-high)', padding: 'var(--spacing-4)', 
                                                            borderRadius: '8px', border: '1px solid var(--color-outline-variant)'
                                                        }}>
                                                            <div>
                                                                <div style={{ color: 'var(--color-primary)', fontWeight: 500, fontSize: '0.95rem', marginBottom: '4px' }}>{doc.title}</div>
                                                                <div style={{ color: 'var(--color-on-surface-variant)', fontSize: '0.8rem' }}>{doc.type}</div>
                                                            </div>
                                                        <button 
                                                            style={{ 
                                            ...
                                            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '10px' }}>
                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                                    <label style={{ fontSize: '0.85rem', color: 'var(--color-on-surface-variant)', fontWeight: 500 }}>Full Name</label>
                                                    <input
                                                        type="text" name="name" required
                                                        style={{
                                                            width: '100%', padding: '8px 12px',
                                                            background: 'var(--color-surface-high)', border: '1px solid var(--color-outline-variant)',
                                                            borderRadius: '8px', color: 'var(--color-primary)', fontSize: '1rem',
                                                            outline: 'none', transition: 'border-color 0.2s, box-shadow 0.2s', boxSizing: 'border-box'
                                                        }}
                                                        onFocus={(e) => { e.target.style.borderColor = 'var(--color-primary)'; e.target.style.boxShadow = '0 0 0 2px var(--color-outline-variant)'; }}
                                                ...
                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                                    <label style={{ fontSize: '0.85rem', color: 'var(--color-on-surface-variant)', fontWeight: 500 }}>Work Email</label>
                                                    <input
                                                ...
                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                                    <label style={{ fontSize: '0.85rem', color: 'var(--color-on-surface-variant)', fontWeight: 500 }}>Phone Number</label>
                                                    <input
                                                        type="tel" name="phone" required
                                                        style={{
                                                            width: '100%', padding: '8px 12px',
                                                            background: 'var(--color-surface-high)', border: '1px solid var(--color-outline-variant)',
                                                            borderRadius: '8px', color: 'var(--color-primary)', fontSize: '0.9rem',
                                                            outline: 'none', transition: 'border-color 0.2s, box-shadow 0.2s', boxSizing: 'border-box'
                                                        }}
                                                        onFocus={(e) => { e.target.style.borderColor = 'var(--color-primary)'; e.target.style.boxShadow = '0 0 0 2px var(--color-outline-variant)'; }}
                                                        onBlur={(e) => { e.target.style.borderColor = 'var(--color-outline-variant)'; e.target.style.boxShadow = 'none'; }}
                                            ...
                                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                                <label style={{ fontSize: '0.85rem', color: 'var(--color-on-surface-variant)', fontWeight: 500 }}>Company Name</label>
                                                <input
                                            ...
                                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                                    <label style={{ fontSize: '0.85rem', color: 'var(--color-on-surface-variant)', fontWeight: 500 }}>Job Role</label>
                                                    <input
                                                        type="text" name="role"
                                                        style={{
                                                            width: '100%', padding: '8px 12px',
                                                ...
                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                                    <label style={{ fontSize: '0.85rem', color: 'var(--color-on-surface-variant)', fontWeight: 500 }}>Primary Interest</label>
                                                    <select
                                                        name="interest"
                                                        style={{
                                                            width: '100%', padding: '8px 12px',
                                            ...
                                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px' }}>
                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                                    <label style={{ fontSize: '0.85rem', color: 'var(--color-on-surface-variant)', fontWeight: 500 }}>Decision Timeframe</label>
                                                    <select
                                                ...
                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                                    <label style={{ fontSize: '0.85rem', color: 'var(--color-on-surface-variant)', fontWeight: 500 }}>Budget Approved?</label>
                                                    <select
                                                ...
                                                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                                    <label style={{ fontSize: '0.85rem', color: 'var(--color-on-surface-variant)', fontWeight: 500 }}>Automation Layer</label>
                                                    <input
                                            ...
                                            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                                <label style={{ fontSize: '0.85rem', color: 'var(--color-on-surface-variant)', fontWeight: 500 }}>Customized Requirements & Details</label>
                                                <textarea
                                                    name="comments"
                                                    style={{
                                            ...
                                            <button
                                                ...
                                                style={{
                                                    ...
                                                    background: type === 'demo' ? 'var(--color-primary)' : 'var(--color-secondary)',
                                                    color: 'var(--color-surface-white)', border: 'none', borderRadius: '8px',
